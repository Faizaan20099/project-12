var garden,rabbit,apple,orangeL,redL,Fruits;
var gardenImg,rabbitImg,carrotImg,orangeImg,redImg,FruitsImg;
...
function preload(){
  ...
  FruitsImg = loadImage("image-removebg-preview.png");
}
...
function createFruits() {
  Fruits = createSprite(random(50, 350),40, 10, 10);
